...
public class MyContentProvider extends ContentProvider {
    ...
    static {
        ...
        uriMatcher.addURI(AUTHORITY,"student",MULTIPLE_STUDENT);/*content://com.onspur.android02/student */
        uriMatcher.addURI(AUTHORITY,"student/#",SINGLE_STUDENT);/*content://com.onspur.android02/student/1 */
    }
    ...
    public Uri insert(Uri uri, ContentValues values) {
        long id=db.insert("student",null,values);//调用数据库
        Uri newUri=null;
        if (id>0){
